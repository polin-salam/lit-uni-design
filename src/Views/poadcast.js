              ...
              <div class="contener">
                ...
                <div class="CourseGroup">
                  ...
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background:rgba(204, 78, 78, 0.7);"></span>
                      <h4>Microservice</h4>
                  ...
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background:rgba(79, 226, 66, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  ...
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background: rgba(231, 178, 79, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  ...
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background: rgba(117, 56, 214, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  </div>
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background:rgba(34, 204, 181, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  </div>
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background: rgba(131, 214, 23, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  </div>
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background:rgba(28, 71, 189, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  </div>
                  <div class="ii">
                    <figure>
                      <span class="dot"
                        style="background:rgba(214, 26, 167, 0.7);"></span>
                      <h4>Microservice</h4>
                      <figcaption>bla bla bla bla bla</figcaption>
                    </figure>
                  </div>
