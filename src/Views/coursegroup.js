...
<div style="height:320px;">
  <p style="padding-left: 10px; font-size: 20px;"> If you have a previous version of Go installed, be sure to
            remove it before installing another.<br>
  ...
  <p style="background-color: cadetblue;
            font-family: 'Roboto', sans-serif; margin-left: 40px; padding-left:30px; width: 400px;">tar -C /usr/local -xzf
              go1.15.6.linux-amd64.tar.gz</p><br>
            Add /usr/local/go/bin to the PATH environment variable.<br>
            2- You can do this by adding the following line to your $HOME/.profile or /etc/profile (for a system-wide
            installation):
</p>
<button> Next</button>
</div>
